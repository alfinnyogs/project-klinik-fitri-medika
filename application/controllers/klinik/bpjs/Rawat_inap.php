...
class Rawat_inap extends CI_Controller{
	public function index()
	{
		...
		$data['rawat_inap'] = $this->db->query("SELECT * FROM pasien ps, rawat_inap_bpjs rib WHERE ps.nomor_pasien=rib.nomor_pasien AND ps.status ='bpjs' ORDER BY id_rawat_inap DESC")->result();
		$this->load->view('templates_klinik/header');
		$this->load->view('templates_klinik/sidebar');
		$this->load->view('klinik/bpjs/inap/rawat_inap', $data);
	...
	public function data_pasien()
	{
		...
		$this->load->view('templates_klinik/header');
		$this->load->view('templates_klinik/sidebar');
		$this->load->view('klinik/bpjs/inap/data_pasien', $data);
		$this->load->view('templates_klinik/footer');
	}
	public function detail_rawat_inap($id)
	{
		$data['rawat_inap'] = $this->db->query("SELECT * FROM pasien ps, datapasien_rawat_inap dri, rawat_inap_bpjs riu WHERE ps.nomor_pasien=riu.nomor_pasien AND dri.id_rawat_inap=riu.id_rawat_inap AND dri.id_rawat_inap='$id' AND dri.kategori_pasien ='BPJS' ORDER BY dri.id_rawat_inap")->result();
		$data['tindakan'] = $this->db->query("SELECT * FROM pasien ps, tindakan_rawatinap tru, rawat_inap_bpjs riu WHERE ps.nomor_pasien=riu.nomor_pasien AND tru.id_rawat_inap=riu.id_rawat_inap AND tru.id_rawat_inap='$id' AND tru.kategori_pasien ='BPJS' ORDER BY tru.id_rawat_inap")->result();
		$this->load->view('templates_klinik/header');
		$this->load->view('templates_klinik/sidebar');
		$this->load->view('klinik/bpjs/inap/detail_pasien_rawat_inap', $data);
		$this->load->view('templates_klinik/footer');
	}
	public function detail_data_pasien($id)
	{
		...
		$this->load->view('templates_klinik/header');
		$this->load->view('templates_klinik/sidebar');
		$this->load->view('klinik/bpjs/inap/detail_data_pasien', $data);
		$this->load->view('templates_klinik/footer');
	}
	public function pendataan_rawat_inap($id)
	{
		...
		$this->load->view('templates_klinik/header');
		$this->load->view('templates_klinik/sidebar');
		$this->load->view('klinik/bpjs/inap/pendataan_rawat_inap', $data);
		$this->load->view('templates_klinik/footer');
	}
	public function pendataan_rawat_inap_aksi()
	{
		...
		if($this->form_validation->run() == FALSE){
			$this->pendataan_rawat_inap($this->input->post('nomor_pasien'));
		}else{
			...
			$this->Models_klinik->insert_data('rawat_inap_bpjs', $data);
			...
			redirect('klinik/bpjs/rawat_inap');
		}
	}
	...
	{
		date_default_timezone_set('Asia/Jakarta');
		$data['pasien'] = $this->Models_klinik->ambil_id_pasienbpjs($id);
		$data['obat'] = $this->Models_klinik->get_data('obat')->result();
		$data['dokter'] = $this->Models_klinik->get_data('dokter')->result();
		$data['biaya_visite_bpjs'] = $this->Models_klinik->get_data('biaya_visite_bpjs')->result();
		$this->load->view('templates_klinik/header');
		$this->load->view('templates_klinik/sidebar');
		$this->load->view('klinik/bpjs/inap/data_pasien_rawat_inap', $data);
		$this->load->view('templates_klinik/footer');
	}
	...
	public function rawat_inap_selesai($id)
	{
    	...
    	$data['selesai'] = $this->db->query("SELECT * FROM pasien ps, rawat_inap_bpjs riu WHERE ps.nomor_pasien=riu.nomor_pasien AND riu.id_rawat_inap='$id' ORDER BY riu.id_rawat_inap")->result();
		$this->load->view('templates_klinik/header');
		$this->load->view('templates_klinik/sidebar');
		$this->load->view('klinik/bpjs/inap/rawat_inap_selesai', $data);
		$this->load->view('templates_klinik/footer');
	}
	public function rawat_inap_selesai_aksi()
    {
    	...
    	$where = array('id_rawat_inap' => $id);
    	$this->Models_klinik->update_data('rawat_inap_bpjs', $data, $where);
    	redirect('klinik/bpjs/rawat_inap');
    }
    public function print_rawat_inap($id)
	{
		$data['pasien'] = $this->db->query("SELECT * FROM pasien ps, datapasien_rawat_inap dri, rawat_inap_bpjs riu WHERE ps.nomor_pasien=riu.nomor_pasien AND dri.id_rawat_inap=riu.id_rawat_inap AND dri.id_rawat_inap='$id' ORDER BY dri.id_rawat_inap")->result();
		$data['tindakan'] = $this->db->query("SELECT * FROM pasien ps, tindakan_rawatinap tru, rawat_inap_bpjs riu WHERE ps.nomor_pasien=riu.nomor_pasien AND tru.id_rawat_inap=riu.id_rawat_inap AND tru.id_rawat_inap='$id' ORDER BY tru.id_rawat_inap")->result();
		$data['rawat_inap'] = $this->db->query("SELECT * FROM pasien ps, rawat_inap_bpjs riu WHERE ps.nomor_pasien=riu.nomor_pasien AND riu.id_rawat_inap='$id' ORDER BY id_rawat_inap")->result();
		...
		$data['total_pendaftaran'] = $this->Models_klinik->total_pendaftaranrawatinap_bpjs($id);
		$this->load->view('klinik/bpjs/inap/print_rawat_inap', $data);
	}
	public function tindakan_rawat_inap($id)
	{
		...
		$this->load->view('templates_klinik/header');
		$this->load->view('templates_klinik/sidebar');
		$this->load->view('klinik/bpjs/inap/tindakan_rawat_inap', $data);
		$this->load->view('templates_klinik/footer');
	}
