...
<head>
  ...
  <title>Invoice &mdash; Rawat Inap BPJS</title>
      ...
      <div class="invoice-print">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="invoice-title">
              <h2>Kuitansi Rawat Inap BPJS</h2>
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-md-right">
                <address>
                  <strong>Tanggal Pendaftaran Rawat Inap BPJS :</strong><br>
                  <?php echo date("d F Y", strtotime($ps->tanggal_pendaftaran)) ?><br>
                  <strong>Biaya Pendaftaran Rawat Inap BPJS :</strong><br>
        ...
        <div class="row mt-4">
          <div class="col-md-12">
            ...
            <div class="section-title">Data Rawat Inap BPJS Pada Tanggal : <?php echo date('d F Y', strtotime($ps->tanggal_pendataan)) ?></div>
            ...
            <div class="section-title">Data Tindakan Rawat Inap BPJS Pada Tanggal : <?php echo date('d F Y', strtotime($ps->tanggal_tindakan)) ?></div>
            <div class="table-responsive">
              <table class="table table-striped table-hover table-md" width="100%">
                <tr>
                  <th data-width="40">No</th>
