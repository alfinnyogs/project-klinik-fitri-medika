      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4>Data Pasien Untuk Rawat Jalan</h4>
            <div class="card-header-form">
              <a href="<?php echo base_url('klinik/bpjs/rawat_jalan') ?>" class="btn btn-warning">Kembali</a>
            </div>
          </div>
          <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="<?php echo base_url('klinik/bpjs/rawat_jalan/detail_data_pasien/').$ps->id_pasien ?>" class="btn btn-sm btn-success">Detail</a>
                        <a href="<?php echo base_url('klinik/bpjs/rawat_jalan/pendataan_rawat_jalan/').$ps->id_pasien ?>" class="btn btn-sm btn-warning">Rawat Jalan</a>
                      </div>
                    </td>
                  </tr>
                <?php endforeach; ?>
