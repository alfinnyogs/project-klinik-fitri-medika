        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-header-form">
              <a href="<?php echo base_url('klinik/bpjs/rawat_jalan/data_pasien') ?>" class="btn btn-primary">Cari Data Pasien</a>
            </div>
          </div>
          <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="<?php echo base_url('klinik/bpjs/rawat_jalan/detail_rawat_jalan/').$rj->id_rawat_jalan ?>" class="btn btn-sm btn-success">Detail</a>
                        <a href="<?php echo base_url('klinik/bpjs/rawat_jalan/print_invoice/').$rj->id_rawat_jalan ?>"class="btn btn-sm btn-primary" target="_blank">Print</a>
                      </div>
                    </td>
                  </tr>
                <?php endforeach; ?>
