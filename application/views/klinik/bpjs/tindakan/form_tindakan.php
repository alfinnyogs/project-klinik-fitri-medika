	    ...
	    <div class="section-header">
		    <h1>Tindakan BPJS</h1>
	     	<div class="section-header-breadcrumb">
		        ...
		        <div class="breadcrumb-item">Form Tindakan BPJS</div>
	      	</div>
		</div>
      		...
      		<div class="col-12">
      			<div class="card">
	                <div class="card-header">
	                    <h4>Form Tindakan BPJS</h4>
	                </div>
	                <div class="card-body">
	                	<form method="post" action="<?php echo base_url('klinik/bpjs/tindakan/form_tindakan_bpjs_aksi') ?>">
	                		...
	                		<div class="row">
	                			...
	                			<div class="col-md-6">
		                    		...
		                    		<a href="<?php echo base_url('klinik/bpjs/tindakan/data_pasien') ?>" class="btn btn-warning float-right mr-2">Kembali</a>
	                			</div>
	                		</div>
	      				</form>
	      			</div>
