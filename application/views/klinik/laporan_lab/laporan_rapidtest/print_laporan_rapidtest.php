      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="invoice-title">
            ...
            <div class="invoice-number">Laporan Rapid Test</div>
          </div>
          <hr>
          <div class="row">
            <div class="col-md-6">
        ...
        <div class="col-md-12">
          <div class="table-responsive">
            <table class="table table-striped table-hover table-md">
              ...
              <?php $no=1; foreach($rapid_test as $a) : ?>
              <tr>
                <td><?php echo $no++ ?></td>
                <td><?php echo $a->nomor_rapidtes ?></td>
                <td><?php echo $a->nik ?></td>
                <td><?php echo $a->nama ?></td>
                <td><?php echo $a->jenis_kelamin ?></td>
                <td><?php echo $a->alamat ?></td>
                <td><?php echo $a->no_hp ?></td>
                <td><?php echo $a->tanggal_rapidtes ?></td>
                <td><?php echo $a->hasil_rapidtes ?></td>
