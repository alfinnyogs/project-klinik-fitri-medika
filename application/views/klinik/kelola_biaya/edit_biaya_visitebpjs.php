...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Kelola Biaya Visite BPJS</h1>
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Kelola Biaya Visite BPJS</div>
      </div>
    </div>
            <div class="card">
                  <div class="card-header">
                      <h4>Edit Kelola Biaya Visite BPJS</h4>
                  </div>
                  <div class="card-body">
                    <form method="post" action="<?php echo base_url('klinik/kelola_biaya/edit_biaya_visitebpjs_aksi') ?>">
                      <?php foreach($visite_bpjs as $ba) : ?>
