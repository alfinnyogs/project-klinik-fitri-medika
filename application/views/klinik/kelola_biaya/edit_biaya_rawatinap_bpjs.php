...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>Kelola Biaya Rawat Inap BPJS</h1>
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Biaya Rawat Inap BPJS</div>
      </div>
    </div>
            <div class="card">
                  <div class="card-header">
                      <h4>Edit Biaya Rawat Inap BPJS</h4>
                  </div>
                  <div class="card-body">
                    <form method="post" action="<?php echo base_url('klinik/kelola_biaya/edit_biaya_rawatinap_bpjs_aksi') ?>">
                      <?php foreach($biaya_rawatinap_bpjs as $bb) : ?>
