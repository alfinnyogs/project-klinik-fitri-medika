      			...
      			<div class="card">
	                ...
	                <div class="card-body">
	                	<div class="row">
                            ...
                            <tr>
                              <th><i class="fas fa-user mr-2"></i>NIK</th>
                            ...
                            <tr>
                              <th><i class="fas fa-phone mr-2"></i>No Telepon</th>
	      					...
	      					<div class="col-6">
	      						<div class="table-responsive">
              						<table class="table table-striped">
                            <tr>
                              <th><i class="far fa-file mr-2"></i>Status Pasien</th>
                              <td><div class="badge badge-primary"><?php echo $ps->status ?></div></td>
                            </tr>
                            <tr>
                              <th><i class="fas fa-building mr-2"></i>No BPJS</th>
                              <td>
                                <?php if($ps->no_bpjs == "0"){ 
                                  echo "-";
                                }else{
                                  echo $ps->no_bpjs;
              							...
              							<tr>
              								<th></th>
              								<td><a href="<?php echo base_url('klinik/kelola_pasien') ?>" class="btn btn-warning float-right">Kembali</a></td>
              							</tr>
              						</table>
              					</div>
	      					</div>
