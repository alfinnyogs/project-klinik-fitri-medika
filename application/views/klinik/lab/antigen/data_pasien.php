  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Antigen</div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4>Data Pasien Untuk Antigen</h4>
            <div class="card-header-form">
              <a href="<?php echo base_url('klinik/lab/kelola_antigen') ?>" class="btn btn-warning">Kembali</a>
            </div>
          </div>
          <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="<?php echo base_url('klinik/lab/kelola_antigen/detail_data_pasien/').$ps->id_pasien ?>" class="btn btn-sm btn-success">Detail</a>
                        <a href="<?php echo base_url('klinik/lab/kelola_antigen/tambah_data_antigen/').$ps->id_pasien ?>" class="btn btn-sm btn-warning">Antigen</a>
                      </div>
                    </td>
                  </tr>
                <?php endforeach; ?>
