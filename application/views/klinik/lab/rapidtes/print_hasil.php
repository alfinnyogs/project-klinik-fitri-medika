...
<head>
  ...
  <title>Rapid Test &mdash; Klinik Fitri Medika</title>
  ...
  <div class="section-body">
    <div class="invoice">
      <div class="invoice-print">
        ...
        <hr>
        <?php foreach($rapidtest as $ps) : ?>
        <div class="row">
          <div class="col-lg-12">
            <div class="invoice-title">
              <h4>Nomor Rapid Test</h4>
              <div class="invoice-number"><?php echo $ps->nomor_rapidtes ?></div>
            </div>
            <hr>
            <div class="row">
              <div class="col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-md-right">
                <address>
                  <strong>Tanggal Rapid Test :</strong><br>
                  <?php echo date("d F Y", strtotime($ps->tanggal_rapidtes)) ?><br><br>
                </address>
              </div>
            </div>
          </div>
        ...
        <div class="row mt-4">
          <div class="col-md-12">
            ...
            <div class="section-title">Menerangkan bahwa berdasarkan hasil pemeriksaan <i>Rapid Test</i> Antibodi yang bersangkutan dinyatakan <b><i><?php echo $rt->hasil_rapidtes ?> Covid 19</i></b></div>
