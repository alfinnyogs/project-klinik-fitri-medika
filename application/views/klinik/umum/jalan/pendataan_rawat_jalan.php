		...
		<div class="row">
      		<div class="col-12">
      			<div class="card">
	                ...
	                <div class="card-body">
	                	<form method="post" action="<?php echo base_url('klinik/umum/rawat_jalan/pendataan_rawat_jalan_aksi') ?>">
		                	...
		                	<div class="row">
	      						...
	      						<div class="col-6">
				                    ...
				                    <?php endforeach; ?>
				                    <div class="form-group">
					                    <label>Total Biaya Rawat Jalan</label>
					                    <div class="input-group">
					                        <div class="input-group-prepend">
						                        <div class="input-group-text">
						                            Rp.
	      					...
	      					<div class="card-body mt-2">
				                ...
				                <a href="<?php echo base_url('klinik/umum/rawat_jalan/data_pasien') ?>" class="btn btn-warning float-right mr-2">Kembali</a>
							</div>
							<?php endforeach; ?>
	      				</form>
	      			</div>
