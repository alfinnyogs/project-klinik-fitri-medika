...
<div class="main-content">
	<section class="section">
	    <div class="section-header">
		    <h1>Tindakan Rawat Inap Umum</h1>
	     	<div class="section-header-breadcrumb">
		        ...
		        <div class="breadcrumb-item">Rawat Inap Umum</div>
		        <div class="breadcrumb-item">Form Tindakan Rawat Inap Umum</div>
	      	</div>
		</div>
      		...
      		<div class="col-12">
      			<div class="card">
	                <div class="card-header">
	                    <h4>Form Tindakan Rawat Inap Umum</h4>
	                </div>
	                <div class="card-body">
	                	<form method="post" action="<?php echo base_url('klinik/umum/rawat_inap/tindakan_rawat_inap_aksi') ?>">
	                		<div class="row">
	                			<div class="col-md-6">
	                				...
	                				<div class="form-group">
					                    ...
					                    <div class="input-group">
					                        ...
					                        <input type="hidden" class="form-control" name="kategori_pasien" value="Umum" readonly>
	                			...
	                			<div class="col-md-6">
		                    		...
		                    		<a href="<?php echo base_url('klinik/umum/rawat_inap') ?>" class="btn btn-warning float-right mr-2">Kembali</a>
	                			</div>
	                		</div>
	      				</form>
	      			</div>
