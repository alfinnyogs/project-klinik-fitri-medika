	    ...
	    <div class="section-header">
		    <h1>Pendaftaran Rawat Inap</h1>
	     	<div class="section-header-breadcrumb">
		        ...
		        <div class="breadcrumb-item">Form Pendaftaran Rawat inap</div>
	      	</div>
		</div>
		...
		<div class="row">
      		<div class="col-12">
      			<div class="card">
	                ...
	                <div class="card-body">
	                	<form method="post" action="<?php echo base_url('klinik/umum/rawat_inap/pendataan_rawat_inap_aksi') ?>">
		                	...
		                	<div class="row">
	      						...
	      						<div class="col-6">
				                    ...
				                    <?php foreach($biaya_rawatinap_umum as $bru) : ?>
				                    <div class="form-group">
				                    ...
				                    <a href="<?php echo base_url('klinik/umum/rawat_inap/data_pasien') ?>" class="btn btn-warning float-right mr-2">Kembali</a>
	      						</div>
	      					</div>
	      					<?php endforeach; ?>
	      				</form>
